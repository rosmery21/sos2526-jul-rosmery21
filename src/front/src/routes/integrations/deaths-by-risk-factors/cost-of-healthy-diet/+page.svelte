...
onMount(async () => {
    try {
        ...
        const resDiet = await fetch('/api/v2/deaths-by-risk-factors/integrations/cost-of-healthy-diet');
...
function renderChart() {
    const bubbleData = dietDataRaw.map(dietItem => {
...
<main class="container">
    ...
    <p>Eje X: coste de vegetales (PPP USD) | Eje Y: muertes por glucosa alta en ayuno | Tamaño: coste total de dieta saludable.</p>
...
<style>
    ...
    .chart-container { max-width: 800px; margin: 0 auto 40px auto; padding: 10px; border: 1px solid #eee; }
