...
// @ts-nocheck
    ...
    onMount(async () => {
        ...
        Highcharts.mapChart(container, {
            ...
            title: { text: 'Temperatura Actual por País' },
...
<main class="container">
	...
	></div>
    <div>
        <p>En este mapa podemos ver una representacion de los países del mundo y su último valor de 
            temperatura registrado en la api open meteo. En el mapa los paises representados con un tono 
            más cálido tienen un temperatura mayor, y los que esta en colores más fríos tienen una menor temperatura.
        </p>
    </div>
</main>
